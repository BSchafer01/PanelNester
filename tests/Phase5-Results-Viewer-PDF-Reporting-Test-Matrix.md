...
| P5-PD-05 | Save-dialog and file-write failures stay actionable | Cancelled save, locked target, unsupported path, or generation failure surface specific user-visible outcomes with no silent partial success | `tests\PanelNester.Desktop.Tests\Bridge\Phase05BridgeSpecs.cs`, `tests\PanelNester.Services.Tests\Reporting\QuestPdfReportExporterSpecs.cs` | Now | §6.7 Report Behavior; Phase 6 error-handling theme |
